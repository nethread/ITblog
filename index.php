...
<body>
    <header class="header">
        <div class="logo_wrapper">
            <h1><a href="/" class="logo">IT<span>blog</span></a></h1>
        </div>
        <!-- logo_wrapper -->
            <nav class="main_nav">
                <ul class="nav_list">
...
<main class="main_wrapper">
    <section class="slider">
        <h2 class="visually_hidden sub_title">Slider</h2>
...
<!-- main_wrapper -->
<footer class="footer">
    <div class="logo_wrapper logo_wrapper_footer">
        <h1><a href="/" class="logo logo_footer">IT<span>blog</span></a></h1>
    </div>
    <section class="social">
        <h2 class="visually_hidden">Мы в социальных сетях</h2>
